...
# Replace with your actual RabbitMQ URL
rabbitmq_publisher = RabbitMQPublisher('amqps://rhhvlgxm:qUM7u0oJtYvNBS-csko-RAbc9AXxAEEL@fish.rmq.cloudamqp.com/rhhvlgxm')
...
def get_random_quote():
    ...
    if random_quote:
        ...
        rabbitmq_publisher.notify_analytics_service()
